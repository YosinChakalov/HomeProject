export default function Card11({ img, title, price, man, woman, kids }) {
    return (
        <>
            <div className="flex bg-[white] rounded-[18px] dark:text-[#eee] dark:bg-[#14143d]">
                <div>
                    <img src={img} alt="" />
                </div>
                <div className="p-[14px_25px] pl-[30px]">
                    <h3 className="text-[rgba(31,36,40,1)] dark:text-[#eee] text-[20px] mb-[10px] font-[bold]">{title}</h3>
